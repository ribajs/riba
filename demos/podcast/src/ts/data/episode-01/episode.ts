...
import { alexanderHeimbuch, michaelaLehr, ericTeubert } from "../contributors/index";
...
export const episode01: PodloveWebPlayerEpisode = {
  ...
  summary: "Lange war es still im Podlove Projekt, das soll sich jetzt ändern! In dieser Episode versuchen wir uns zunächst an einer Definition von Podlove und stellen die drei Projekte Podlove Publisher, Podlove Web Player sowie Podlove Subscribe Button vor. Zentral geht es aber eigentlich um die Entwickler:innen: Wer wir sind, wie wir in das Projekt gekommen sind, was uns motiviert und wie wir mit Podlove weiter machen wollen.",
  publicationDate: "2020-07-15T15:37:32+00:00",
  duration: "00:50:03.900",
  poster: "https://backend.podlovers.org/wp-content/cache/podlove/8c/b68ab69fc23b3e57cdcdbd70f87f08/wir-muessen-reden_500x.png",
  ...
  contributors: [
    alexanderHeimbuch, michaelaLehr, ericTeubert,
  ],
  transcripts,
};
