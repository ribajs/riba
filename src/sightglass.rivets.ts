...
let sightglassAdapters: any = {};
let sightglassRoot: any;
...
export class Observer {
  ...
  static updateOptions = function(options) {
    sightglassAdapters = options.adapters;
    // interfaces = Object.keys(adapters);
    sightglassRoot = options.rootInterface;
  }
  ...
  parse() {
    ...
    if (!!~interfaces.indexOf(this.keypath[0])) {
      ...
      if (typeof (root = this.options.root || sightglassRoot) === 'undefined') {
  ...
  interfaces() {
    ...
    Object.keys(sightglassAdapters).forEach(function(i) {
