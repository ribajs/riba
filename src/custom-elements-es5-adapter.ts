...
(() => {
  ...
  const define = (tagname, elementClass) => {
    ...
    (StandInElement as any).observedAttributes = elementClass.observedAttributes;
    (standInProto as any).connectedCallback = elementProto.connectedCallback;
    (standInProto as any).disconnectedCallback = elementProto.disconnectedCallback;
    (standInProto as any).attributeChangedCallback = elementProto.attributeChangedCallback;
    (standInProto as any).adoptedCallback = elementProto.adoptedCallback;
