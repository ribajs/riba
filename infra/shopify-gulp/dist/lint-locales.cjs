...
const lint_reporter_cjs_1 = __importDefault(require("./includes/lint-reporter.cjs"));
/**
...
function lintLocales() {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, theme_lint_1.runAll)(config_cjs_1.config.src.root, new lint_reporter_cjs_1.default())
...
//# sourceMappingURL=lint-locales.cjs.map