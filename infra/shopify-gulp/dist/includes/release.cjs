...
const compressForStore = (envKey, settingsData, zipFilename) => __awaiter(void 0, void 0, void 0, function* () {
    yield fs_1.promises.mkdir(config_cjs_1.config.upload, { recursive: true });
    if (!zipFilename) {
        zipFilename = (0, config_cjs_1.getReleaseZipFilename)(envKey);
    }
    const archive = (0, archiver_1.default)("zip");
    const include = "**/*";
    const distPath = path_1.default.resolve(config_cjs_1.config.themeRoot, config_cjs_1.config.dist.root);
    const ignore = "config.yml";
    const zipPath = path_1.default.resolve(config_cjs_1.config.upload, zipFilename);
