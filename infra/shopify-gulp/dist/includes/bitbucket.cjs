...
const uploadFile = (filePath) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (exists) {
        console.warn(messages_cjs_1.default.colorize(`The file "${filename}" already exists on bitbucket, normally the file will be overwritten, but if there are problems delete the file in bithucket and try it again`), "warning");
    }
    ...
    yield (0, utilities_cjs_1.asnycTimeout)(3000);
    return result;
});
