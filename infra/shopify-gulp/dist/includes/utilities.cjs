...
exports.findFile = exports.processCache = exports.createEventCache = exports.processSvg = exports.promiseSeries = exports.errorHandler = exports.outputErrors = exports.asyncSleep = exports.asnycTimeout = exports.isNumber = void 0;
const gulp_util_1 = __importDefault(require("gulp-util"));
const lodash_1 = __importDefault(require("lodash"));
const bluebird_1 = __importDefault(require("bluebird")); // TODO: Replace with a native solution, e.g. https://github.com/VeryCrazyDog/native-promise-util
