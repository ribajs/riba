// Custom version of https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/gulp/index.d.ts
...
declare module "gulp" {
  import type * as vfs from "vinyl-fs";
  import type * as chokidar from "chokidar";
  import type * as Undertaker from "undertaker";
  import type { noop } from "gulp-util";
  import type * as fs from "fs";

  export type Globs = string | string[];

  export type TaskFunction = Undertaker.TaskFunction;

  /**
   * @deprecated - Now use `TaskFunction`.
   */
  export type TaskCallback = TaskFunction;

  export type TaskFunctionCallback = Undertaker.TaskCallback;

  export interface Gulp extends Undertaker {
    /**
  ...
  export type SrcMethod = typeof vfs.src;

  export type DestMethod = typeof vfs.dest;
