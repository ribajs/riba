...
export const TS_SOURCE_DIR: Config['tsSourceDir'] = findDir([
...
export const SCSS_SOURCE_DIR: Config['scssSourceDir'] = findDir([
...
export const TEMPLATE_DIR: Config['templateDir'] = findDir([
...
export const DIST_DIR_OCTOBERCMS: Config['distDir'] = resolve(rootPath, "assets/js/");
export const DIST_DIR_SHOPIFY: Config['distDir'] = resolve(rootPath, "theme/assets/");
