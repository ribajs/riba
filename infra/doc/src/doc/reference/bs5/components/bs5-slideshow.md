<rv-bind-content class="pt-3">
  <template>
    <rv-example-tabs handle="bs5-slideshow-1" class="pt-3">
      <template type="single-html-file">
        <bs5-slideshow controls="false" lg-controls="true" indicators="false" lg-indicators="true" control-prev-icon-src="/iconset/arrow_carrot_alt.svg" control-next-icon-src="/iconset/arrow_carrot_alt.svg" indicator-inactive-icon-src="/iconset/icon_circle-empty.svg" indicator-active-icon-src="/iconset/icon_circle-selected.svg" sticky="true" autoplay="true" autoplay-interval="10000">
          <div class="slideshow-inner">
            <div class="slide col-12 p-0">
              ...
              <div class="slide-caption">
                <h1>bs5-slideshow<br><small>The last bootstrap carousel you'll ever need</small></h1>
              </div>
            </div>
            <div class="slide col-12 p-0">
...
<rv-bind-content class="pt-3">
  <template>
    <rv-example-tabs handle="bs5-slideshow-1" class="pt-3">
      <template type="single-html-file">
        <bs5-slideshow controls="false" lg-controls="true" indicators="false" lg-indicators="true" control-prev-icon-src="/iconset/arrow_carrot.svg" control-next-icon-src="/iconset/arrow_carrot.svg" indicator-inactive-icon-src="/iconset/icon_circle-empty.svg" indicator-active-icon-src="/iconset/icon_circle-selected.svg" slides-to-scroll="3" indicators="false">
          <div class="slideshow-inner">
...
<rv-bind-content class="pt-3">
  <template>
    <rv-example-tabs handle="bs5-slideshow-1" class="pt-3">
      <template type="single-html-file">
        <bs5-slideshow controls="false" lg-controls="true" indicators="false" lg-indicators="true" control-prev-icon-src="/iconset/arrow_carrot.svg" control-next-icon-src="/iconset/arrow_carrot.svg" indicator-inactive-icon-src="/iconset/icon_circle-empty.svg" indicator-active-icon-src="/iconset/icon_circle-selected.svg">
...
<rv-bind-content class="pt-3">
  <template>
    <rv-example-tabs handle="bs5-slideshow-1" class="pt-3">
      <template type="single-html-file">
        <bs5-slideshow autoplay="true" autoplay-velocity="0.05" controls="false" lg-controls="true" indicators="false" lg-indicators="true" control-prev-icon-src="/iconset/arrow_carrot.svg" indicator-inactive-icon-src="/iconset/icon_circle-empty.svg" indicator-active-icon-src="/iconset/icon_circle-selected.svg" control-next-icon-src="/iconset/arrow_carrot.svg">
          <div class="slideshow-inner">
...
<rv-bind-content class="pt-3">
  <template>
    <rv-example-tabs handle="bs5-slideshow-1" class="pt-3">
      <template type="single-html-file">
        <bs5-slideshow autoplay="true" autoplay-interval="4000" controls="false" lg-controls="true" indicators="false" lg-indicators="true" control-prev-icon-src="/iconset/arrow_carrot.svg" indicator-inactive-icon-src="/iconset/icon_circle-empty.svg" indicator-active-icon-src="/iconset/icon_circle-selected.svg" control-next-icon-src="/iconset/arrow_carrot.svg">
          <div class="slideshow-inner">
            <div class="slide-placeholder d-none d-sm-block col-sm-6 col-xl-4">&nbsp;</div>
            <div class="slide col-12 col-sm-6 col-xl-4">
              <img lazyload="lazy" class="img-fluid w-100" src="https://picsum.photos/1000/400?random=1" alt="Static Random Image from https://picsum.photos/">
...
<rv-bind-content class="pt-3">
  <template>
    <rv-example-tabs handle="bs5-slideshow-1" class="pt-3">
      <template type="single-html-file">
        <bs5-slideshow controls="false" lg-controls="true" indicators="false" lg-indicators="true" control-prev-icon-src="/iconset/arrow_carrot.svg" control-next-icon-src="/iconset/arrow_carrot.svg" indicator-inactive-icon-src="/iconset/icon_circle-empty.svg" indicator-active-icon-src="/iconset/icon_circle-selected.svg" sticky="true">
          <div class="slideshow-inner">
...
<rv-bind-content class="pt-3">
  <template>
    <rv-example-tabs handle="bs5-slideshow-1" class="pt-3">
      <template type="single-html-file">
        <bs5-slideshow controls="false" lg-controls="true" indicators="false" lg-indicators="true" sticky="true">
          <div class="slideshow-inner">
