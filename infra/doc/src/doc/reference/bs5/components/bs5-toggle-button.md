...
This site itself uses the `bs5-toggle-button` to open or close the sidebar.
...
<rv-bind-content class="pt-3">
  <template>
    <rv-example-tabs handle="bs5-toggle-button-component" class="pt-3">
      <template type="single-html-file">
        <bs5-toggle-button target-id="main-sidebar" class="p-3">
        ...
        <bs5-toggle-button target-id="example-sidebar" class="p-3">
