...
<rv-bind-content class="pt-3">
  <template>
    <rv-example-tabs class="pt-3" handle="bs5-contents">
      <template type="single-html-file">
        <bs5-contents headers-start="1" headers-depth="6" header-parent-selector="#header-example-wrapper" scroll-offset="80" scroll-element="[handle='bs5-contents'] .tab-content"></bs5-contents>
