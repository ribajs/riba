Component to collapse multiple cards like an accordion as it exists on [the original bootstrap](https://getbootstrap.com/docs/5.3/components/collapse/#accordion-example) example.
Each accordion item is added by a `<template>` element with a `title` attribute and its content as the accordion item body.
  ...
  <template>
    <rv-example-tabs handle="bs5-navbar" class="pt-3">
      <template type="single-html-file">
        <bs5-accordion collapse-icon-src="/iconset/arrow_carrot_thin.svg">
