!(function (e) {
  function t(t) {
    for (
      var n, u, a = t[0], l = t[1], f = t[2], p = 0, s = [];
      p < a.length;
      p++
    )
      (u = a[p]),
  ...
  let a = (window.webpackJsonp = window.webpackJsonp || []),
    l = a.push.bind(a);
  (a.push = t), (a = a.slice());
  for (let f = 0; f < a.length; f++) t(a[f]);
  var c = l;
  i.push([136, 1]), r();
})({
  136: function (e, t, r) {
  ...
  137: function (e, t, r) {
    ...
    var n = r(4),
      ...
      f = function e() {
        o()(this, e),
          u()(this, "riba", new a.Riba()),
          this.riba.module.regist(a.coreModule),
          this.riba.module.regist(l.default),
          this.riba.bind(document.body, window.model);
      };
    a.Utils.domIsReady(function () {
      new f();
    });
  },
});
