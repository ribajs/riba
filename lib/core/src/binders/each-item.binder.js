...
exports.eachStarBinder = {
    ...
    routine(el, collection) {
        ...
        collection.forEach((model, index) => {
            const scope = { $parent: this.view.models };
            ...
            if (!view) {
                ...
                view = view_1.View.create(this, scope, previous.nextSibling);
                ...
                if (view.models[modelName] !== model) {
                    ...
                    if (matchIndex !== undefined) {
                        ...
                        // new model
                        nextView = view_1.View.create(this, scope, view.els[0]);
                    }
        ...
        if (this.customData.iterated.length > collection.length) {
            utils_1.Utils.times(this.customData.iterated.length - collection.length, () => {
