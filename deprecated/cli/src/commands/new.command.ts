...
export class NewCommand extends AbstractCommand {
  public load(program: CommanderStatic) {
    program
      ...
      .option(
        "-e, --skip-examples",
        "Allow to skip generation of example files."
      )
      ...
      .option(
        "-l, --language [language]",
        "Specify ts or js language to use",
        "ts"
      )
      .option(
        "-sl, --style-language [styleLanguage]",
        "Specify css or scss style sheet language to use",
        "scss"
      )
      .option(
        "-t, --template-engine [templateEngine]",
        "Specify template engine to use",
        "html"
      )
      .option(
