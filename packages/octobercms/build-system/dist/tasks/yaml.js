...
const scss_to_october_js_1 = require("./includes/scss-to-october.js");
const merge_october_yaml_js_1 = require("./includes/merge-october-yaml.js");
...
(0, gulp_1.task)("build-yml", function buildExampleYmlFromScss() {
    return (0, gulp_1.src)("./assets/**/*.scss")
        .pipe((0, scss_to_october_js_1.scssToOctoberYml)())
...
(0, gulp_1.task)("merge-with-october-yml", function mergeOctoberYamlTask() {
    return (0, gulp_1.src)("./default_theme.yaml", { allowEmpty: true })
        .pipe((0, merge_october_yaml_js_1.mergeOctoberFormFields)("./build/bundle.yml"))
        .pipe((0, gulp_1.dest)("./"));
});
