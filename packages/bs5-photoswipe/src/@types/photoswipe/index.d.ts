...
declare class PhotoSwipe<T extends PhotoSwipe.Options, UI,> {
   ...
   */
  currItem: PhotoSwipe.CurrentItem;
  ...
  // undocumentated but used in photoswipe-ui-default.js
  ...
  setScrollOffset(x: number, y: number): number;
  ...
  toggleDesktopZoom(zoomLevel?: number): void;
}
