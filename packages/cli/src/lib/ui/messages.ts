...
export const messages = {
  ...
  RIBA_INFORMATION_PACKAGE_MANAGER_FAILED: `${emojis.SMIRK}  cannot read your project package.json file, are you inside your project directory?`,
  QUESTION_NAME_OF_NEW_PROJECT: `What name would you like to use for the ${emojis.CHICK}  project? `,
};