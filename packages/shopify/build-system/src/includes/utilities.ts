...
import Bluebird from "bluebird"; // TODO remove this dep
...
const utilities = {
  ...
  asnycTimeout: async (ms: number) => {
    return new Promise((resolve) => setTimeout(resolve, ms));
  },

  // https://stackoverflow.com/a/33292942/1465919
  asyncSleep: async (fn: any, ...args: any[]) => {
   ...
   */
  promiseSeries: async (promiseArrayFactory: Array<() => Promise<any>>) => {
