// Outsource tghe riba event dispatcher to his own package

import type { Events, EventCallback, BoundEventCallback } from '@ribajs/core';
...
export class EventDispatcher {
  public static instances: { [namespace: string]: EventDispatcher } = {};
